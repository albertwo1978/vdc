...
1. This deployment integrates kubernetes RBAC with Azure Active Directory and creates a base set of personas for managing resounces in the AKS cluster. can 

A description of those personas and their permission level can be found below:
