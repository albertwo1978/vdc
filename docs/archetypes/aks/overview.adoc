...
Once completed, please reference the https://github.com/albertwo1978/vdc/blob/master/docs/archetypes/aks/overview.adoc#aks-cluster-topology-view[AKS Cluster Topology Diagram] for a view of the deployed resources. 
