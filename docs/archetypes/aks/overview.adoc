...
1. This deployment integrates kubernetes RBAC with Azure Active Directory and creates a base set of personas for managing resounces within the AKS cluster. A description of those personas and their permission levels can be found below:
