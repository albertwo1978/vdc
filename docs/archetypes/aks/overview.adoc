...
1. *Azure Kubernetes Services (AKS) Cluster* - 

1. *Azure Virtual Network w/ Subnet* - 

1. *Azure Key Vault* - 

1. *Firewall Rule in Shared Services Archetype* -


1. The following resources were also deployed as part of the AKS archetype and are explained in further details in the link:overview.adoc#deployment-assumptions[deployment assumptions] section below: 
   - *Container Registry*
   - *Audit Logging* 
   - *AAD Roles*
   - *Kubernetes personas* 
