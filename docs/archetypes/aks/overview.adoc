...
| Unique to AAD Tenant
| Cluster User persona AAD group in the RBAC Tenant (used to manage group membership). A description of each persona can be found below in the AKS archetype description. 
